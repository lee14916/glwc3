'''
cat data_aux/dat_ignore/analysis_C20_disc_run | xargs -I @ -P 3 python3 -u analysis_C20_disc.py -t @ > log/analysis_C20_disc.out & 
'''
import util as yu
from util import *
