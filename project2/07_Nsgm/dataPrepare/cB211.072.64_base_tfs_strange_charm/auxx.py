...
pathBase='/capstor/store/cscs/userlab/lp139/lyan/code/projectData_old/01_Nsgm/cB211.072.64_base/'
temp=os.getcwd().split('/')[-1]
pathBaseTf=f'/capstor/store/cscs/userlab/lp139/lyan/code/projectData_old/01_Nsgm/cB211.072.64_base_strange_charm/'
pathBaseCode='/capstor/store/cscs/userlab/lp139/lyan/code/glwc3/project2/01_Nsgm/dataPrepare/cB211.072.64_base/'
pathBaseCodeTf='/capstor/store/cscs/userlab/lp139/lyan/code/glwc3/project2/07_Nsgm/dataPrepare/cB211.072.64_base_tfs_strange_charm/'
...
path_diags_all=pathBaseCodeTf+'data_aux/diags_all'
path_diags_main=pathBaseCodeTf+'data_aux/diags_main'
...
diag_init=[
    [['N','N_bw'],{'N'},\
        [[],['pi0i'],['pi0f'],['P'],['pi0f','pi0i'], ['j'],['j','pi0i'],['pi0f','j']
         ,['P','j'],['pi0f','j','pi0i']]],
    [['T','T_bw'],{'N','pib'},\
        [[],['pi0f'],['j'],['pi0f','j']]],
    [['B2pt','W2pt','Z2pt','B2pt_bw','W2pt_bw','Z2pt_bw'],{'N','pia','pib'},\
