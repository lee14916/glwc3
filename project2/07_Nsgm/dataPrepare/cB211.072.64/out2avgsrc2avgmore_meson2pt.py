...
def cfg2out_jPP(cfg):
    path='/capstor/store/cscs/userlab/lp139/lyan/code/scratch/run/Nsgm/cB211.072.64/jPP/out/'+cfg+'/'
    return path

def cfg2out_loop(cfg):
    path='/capstor/store/cscs/userlab/lp139/lyan/code/scratch/run/Nsgm/cB211.072.64/loop/out/'+cfg+'/'
    return path
...
def run(cfg):
    ...
    outpath='/capstor/store/cscs/userlab/lp139/lyan/code/projectData/07_Nsgm/cB211.072.64/data_avgsrc/'+cfg+'/'
                ...
                for fla0 in ['pi+','pi-','pi0']:
                    ...
                    for flaa in flas:
                        for flab in flas:
                            ...
                            if flaa not in ['sgm'] or flab not in ['sgm']:
                                continue
    ...
    inpath=f'/capstor/store/cscs/userlab/lp139/lyan/code/projectData/07_Nsgm/cB211.072.64/data_avgsrc/{cfg}/'
    outpath=f'/capstor/store/cscs/userlab/lp139/lyan/code/projectData/07_Nsgm/cB211.072.64/data_avgmore/{cfg}/'
    os.makedirs(outpath,exist_ok=True)
