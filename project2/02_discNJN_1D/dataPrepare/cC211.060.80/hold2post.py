'''
cat data_aux/cfgs_run | xargs -I @ -P 10 python3 -u hold2post.py -c @ > log/hold2post.out & 
'''
import re, click
import h5py, os
import numpy as np
...
def run(cfg):
    ...
    outpath=f'/p/project1/ngff/li47/code/projectData/02_discNJN_1D/{ens}/data_post/{cfg}/'
