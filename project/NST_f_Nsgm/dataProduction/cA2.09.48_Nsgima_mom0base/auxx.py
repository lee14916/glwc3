...
def cfg2post(cfg,case):
    file={'pi0f':'pi0f.h5_loops-f-NstocL400-NstocS100-Nsigma','P':'P.h5_jPP-f-Nsigma',
            'j':'j.h5_loops-f-NstocL400-NstocS100-Nsigma','jPi':'jPi.h5_jPP-f-Nsigma'}[case]
...
if __name__ == "__main__":
    ...
    for opa in ops:
        for opb in ops:
            ...
            t1={'N':{'N'},'N,sgm':{'N','pia'}}[flaa]
            t2={'N':{'N'},'N,sgm':{'N','pib'}}[flab]
            opab=opa+'_'+opb
